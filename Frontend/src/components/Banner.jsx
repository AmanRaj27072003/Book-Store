      ...
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10 ">
        <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-32">
          <div className="space-y-10">
            ...
            <p className="text-xl">
              Explore our free reading website—a gateway to a vast collection of
              books, articles, and stories. Dive into endless genres and
              discover new worlds, ideas, and perspectives at your fingertips.{" "}
              <br />
              Just signup and unlock more content for better experience.
            </p>
        ...
        <div className="w-full order-1 md:w-1/2">
          <img src={book1} className="w-82 h-82 mx-8 my-6" alt="" />
        </div>
      </div>
    </>
  );
